    ...
    <section className="py-8 sm:py-12 md:py-16 bg-black">
      <div className="container mx-auto px-4 sm:px-6 space-y-4 sm:space-y-6 text-center text-sm sm:text-sm md:text-base lg:text-lg text-white">
        ...
        <p className="max-w-[950px] mx-auto">
          ...
          trademarks, logos, and images are the property of their respective
          owners. All references are made for identification purposes only and
          are used under applicable fair use and trademark laws, including EU
          Regulation 2017/1001, Article 14, and relevant U.S. trademark
          principles.
        </p>
      </div>
    </section>
