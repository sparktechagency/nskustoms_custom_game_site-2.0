...
const Feedback = () => {
  ...
  const stats = [
    { icon: Package, label: 'Completed orders', value: '0', color: 'text-red-500' },
    { icon: ThumbsUp, label: 'Positive feedback', value: '0', color: 'text-blue-500' },
    { icon: ThumbsDown, label: 'Negative feedback', value: '0', color: 'text-blue-400' },
    { icon: Star, label: 'Feedback score', value: '0', color: 'text-yellow-500' }
  ];
    ...
    <div className="">
      <div className="">
        ...
        <div className="bg-gray-800/30 backdrop-blur-sm rounded-lg border border-gray-700/50 p-12 flex flex-col items-center justify-center min-h-[400px]">
          <div className="text-6xl mb-4"><Image src={notfund} alt='image' /></div>
